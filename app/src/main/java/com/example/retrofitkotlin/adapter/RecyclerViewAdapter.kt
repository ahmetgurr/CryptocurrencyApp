...
import com.example.retrofitkotlin.view.MainActivity

class RecyclerViewAdapter(private val cryptoList: ArrayList<CryptoModel>, private val listener: MainActivity) : RecyclerView.Adapter<RecyclerViewAdapter.RowHolder>() {
